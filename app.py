...
# 작성자 정보 입력
st.markdown("<p style='font-size:16px; margin-top: 20px;'>✏️ 작성자 정보 입력</p>", unsafe_allow_html=True)
name = st.text_input("작성자 이름을 입력하세요")
department = st.text_input("작업 부서명을 입력하세요")

# 사진 업로드 섹션
st.markdown("<p style='font-size:16px; margin-top: 20px;'>📷 사진 업로드</p>", unsafe_allow_html=True)
...
# 질문 섹션
st.markdown("<p style='font-size:16px; margin-top: 20px;'>📋 위험성평가 질문</p>", unsafe_allow_html=True)
